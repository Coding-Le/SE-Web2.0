window.onload =  function() {
	...
	for (var i = 1; i <= 16; i++) {
		...
		img_block.src = "img/adult/"+i.toString()+".gif";
	...
	function response (e) {
		...
		if (isAdjacency(index, blank_pos)) {
			...
			img_blocks[blank_pos-1].src = temp;
			 ...
			 for (var j = 1; j <= 16; j++) {
			 	var temp1 = "img/childhood/"+j.toString()+".gif";
			 	var temp2 = "img/adult/"+j.toString()+".gif";
	...
	choose.onchange = function() {
		if (index == 2) {
			for (var i = 1; i <= 16; i++) {
				img_blocks[i-1].src = "img/adult/"+i.toString()+".gif";
				img_blocks[i-1].id = "";
			}
			index = 1;
		} else if (index== 1) {
			for (var i = 1; i <= 16; i++) {
				img_blocks[i-1].src = "img/childhood/"+i.toString()+".gif";
				img_blocks[i-1].id = "";
			}
			index = 2;
		} else {
