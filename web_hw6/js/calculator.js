var calculator = {
	...
	leftOper: document.getElementById("left-oper"),
	equals: document.getElementById("equal"),
	plus: document.getElementById("plus"),
	clear: document.getElementById("c"),
	del: document.getElementById("del"),
	dot: document.getElementById("dot"),
	rightOper:document.getElementById("right-oper"),
	...
	clicks:function() {
		...
		calculator.equals.onclick= function () {
			try {
				...
				alert("Invalid input string!!! Please input again.");
			}
		};

		calculator.leftOper.onclick= function () {
			calculator.display.value+= " (";
		};

		calculator.rightOper.onclick= function () {
			calculator.display.value+= " )";
		};
